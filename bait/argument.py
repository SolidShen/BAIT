...
class BAITArguments:
    ...
    early_stop_q_score_threshold: float = field(default=0.98, metadata={"help": "Threshold for early stopping based on expectation"})
...
class DataArguments:
    ...
    forbidden_unprintable_token: bool = field(default=False, metadata={"help": "Forbid unprintable tokens to accelerate the scanning efficiency"})
